...
# namedtuple 用来创建一个自定义的tuple对象，并且规定了
...
def default_dict():
    d = collections.defaultdict(lambda: "ALISURE")
    d["key1"] = "asdfg"
    print(d["key1"])
    print(d["key2"])
    pass
...
def counter():
    ...
    for ch in "asdfdsasdfdsasddasfdsadfdsaadfggdaafgfsa":
        c[ch] += 1
    print(c)
    pass
